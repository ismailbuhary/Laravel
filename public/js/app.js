...
Vue.component('message', __webpack_require__(33));
  ...
  methods: {
    send: function send() {
      if (this.message.length != 0) {
        console.log(this.chat.msgs.push(this.message));
        this.message = '';
      } else {}
    },
...
Component.options.__file = "C:\\Users\\mbuhary\\workspace-muzbnb\\laravel\\resources\\assets\\js\\components\\message.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cfb1d854", Component.options)
  } else {
    hotAPI.reload("data-v-cfb1d854", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-cfb1d854", module.exports)
  }
}
